...
// Public domain 8x8 font (font8x8_basic by Daniel Hepper / IBM VGA fonts).
...
Surface TextRenderer::render(std::string_view text, const RasterOptions& options) const {
  ...
  int glyphWidth = options.pixelWidth > 0 ? options.pixelWidth
  ...
  if (options.antialias) {
    ...
    avs::effects::detail::boxBlur(blurred, surface.width, surface.height, radius);
