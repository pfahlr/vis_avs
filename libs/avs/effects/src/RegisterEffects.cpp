...
void registerCoreEffects(avs::core::EffectRegistry& registry) {
  ...
  registry.registerFactory("Channel Shift",
                           []() { return std::make_unique<Effect_ChannelShift>(); });
  registry.registerFactory("channel shift",
                           []() { return std::make_unique<Effect_ChannelShift>(); });
  registry.registerFactory("Color Reduction",
                           []() { return std::make_unique<Effect_ColorReduction>(); });
  registry.registerFactory("color reduction",
                           []() { return std::make_unique<Effect_ColorReduction>(); });
  registry.registerFactory("Holden04: Video Delay",
                           []() { return std::make_unique<Effect_Holden04VideoDelay>(); });
  registry.registerFactory("holden04: video delay",
                           []() { return std::make_unique<Effect_Holden04VideoDelay>(); });
  registry.registerFactory("Holden05: Multi Delay",
                           []() { return std::make_unique<Effect_Holden05MultiDelay>(); });
  registry.registerFactory("holden05: multi delay",
                           []() { return std::make_unique<Effect_Holden05MultiDelay>(); });
  registry.registerFactory("Misc / Comment",
                           []() { return std::make_unique<Effect_MiscComment>(); });
  registry.registerFactory("misc / comment",
                           []() { return std::make_unique<Effect_MiscComment>(); });
  registry.registerFactory("Misc / Custom BPM",
                           []() { return std::make_unique<Effect_MiscCustomBpm>(); });
  registry.registerFactory("misc / custom bpm",
                           []() { return std::make_unique<Effect_MiscCustomBpm>(); });
  registry.registerFactory("Misc / Set render mode",
                           []() { return std::make_unique<Effect_MiscSetRenderMode>(); });
  registry.registerFactory("misc / set render mode",
                           []() { return std::make_unique<Effect_MiscSetRenderMode>(); });
  ...
  registry.registerFactory("Render / Bass Spin",
                           []() { return std::make_unique<Effect_RenderBassSpin>(); });
  registry.registerFactory("render / bass spin",
                           []() { return std::make_unique<Effect_RenderBassSpin>(); });
  ...
  registry.registerFactory("Render / Dot Plane",
                           []() { return std::make_unique<Effect_RenderDotPlane>(); });
  registry.registerFactory("render / dot plane",
                           []() { return std::make_unique<Effect_RenderDotPlane>(); });
  registry.registerFactory("Render / Moving Particle",
                           []() { return std::make_unique<Effect_RenderMovingParticle>(); });
  registry.registerFactory("render / moving particle",
                           []() { return std::make_unique<Effect_RenderMovingParticle>(); });
  registry.registerFactory("Render / Oscilloscope Star",
                           []() { return std::make_unique<Effect_RenderOscilloscopeStar>(); });
  registry.registerFactory("render / oscilloscope star",
                           []() { return std::make_unique<Effect_RenderOscilloscopeStar>(); });
  ...
  registry.registerFactory("Render / Rotating Stars",
                           []() { return std::make_unique<Effect_RenderRotatingStars>(); });
  registry.registerFactory("render / rotating stars",
                           []() { return std::make_unique<Effect_RenderRotatingStars>(); });
  registry.registerFactory("Render / Simple",
                           []() { return std::make_unique<Effect_RenderSimple>(); });
  registry.registerFactory("render / simple",
                           []() { return std::make_unique<Effect_RenderSimple>(); });
  registry.registerFactory("Render / SVP Loader",
                           []() { return std::make_unique<Effect_RenderSvpLoader>(); });
  registry.registerFactory("render / svp loader",
                           []() { return std::make_unique<Effect_RenderSvpLoader>(); });
  ...
  registry.registerFactory("Trans / Blitter Feedback",
                           []() { return std::make_unique<Effect_TransBlitterFeedback>(); });
  registry.registerFactory("trans / blitter feedback",
                           []() { return std::make_unique<Effect_TransBlitterFeedback>(); });
  ...
  registry.registerFactory("Trans / Brightness",
                           []() { return std::make_unique<Effect_TransBrightness>(); });
  registry.registerFactory("trans / brightness",
                           []() { return std::make_unique<Effect_TransBrightness>(); });
  registry.registerFactory("Trans / Color Clip",
                           []() { return std::make_unique<Effect_TransColorClip>(); });
  registry.registerFactory("trans / color clip",
                           []() { return std::make_unique<Effect_TransColorClip>(); });
  registry.registerFactory("Trans / Color Modifier",
                           []() { return std::make_unique<trans::ColorModifier>(); });
  registry.registerFactory("trans / color modifier",
                           []() { return std::make_unique<trans::ColorModifier>(); });
  registry.registerFactory("Trans / Colorfade",
                           []() { return std::make_unique<Effect_TransColorfade>(); });
  registry.registerFactory("trans / colorfade",
                           []() { return std::make_unique<Effect_TransColorfade>(); });
  registry.registerFactory("Trans / Mosaic",
                           []() { return std::make_unique<Effect_TransMosaic>(); });
  registry.registerFactory("trans / mosaic",
                           []() { return std::make_unique<Effect_TransMosaic>(); });
  registry.registerFactory("Trans / Roto Blitter",
                           []() { return std::make_unique<Effect_TransRotoBlitter>(); });
  registry.registerFactory("trans / roto blitter",
                           []() { return std::make_unique<Effect_TransRotoBlitter>(); });
